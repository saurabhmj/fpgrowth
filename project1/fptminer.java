...
public class fptminer {
	...
	public fptminer(int minsup, double minconf) {
	...
	public static void main(String[] args) throws Exception {
		...
		fptminer fp = new fptminer(15, 0.95);
		
		System.out.println("Reading input file...");
		DataSetReader dsr = new DataSetReader("/home/jogal002/Downloads/inter");
		dsr.generateDataSet();
		...
		fp.frequentItemSets = new HashMap<>(mapOfcounts);

		System.out.println("Implementing FP growth...");		
		fp.FPGrowth(fpTree);
		
		
		System.out.println("Itemsets found : "+fp.frequentItemSets.size());
		...
		if(fp.minsup > 20) {
			...
			for (Entry<List<String>, Double> entry : fp.frequentItemSetsForAssociations.entrySet()) {
				...
				AssociationRule ar = new AssociationRule(entry.getKey(), entry.getKey(), new ArrayList<String>());
